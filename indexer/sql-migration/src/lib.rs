...
mod m20260521_124756_transactions_sender_block_height_transaction_idx;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20260521_124756_transactions_sender_block_height_transaction_idx::Migration),
        ]
    }
