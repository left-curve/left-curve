        ...
        format!(
            r#"
              ...
              SELECT
                ...
                argMinState(open_price, created_at) AS open,
                maxState(highest_price) AS high,
                minState(lowest_price) AS low,
                argMaxState(close_price, created_at) AS close,
