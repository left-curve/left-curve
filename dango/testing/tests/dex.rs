use {
    ...
    dango_types::{
        ...
        constants::{atom, btc, dango, eth, usdc, xrp},
        dex::{
...
#[test_case(
    btree_map! {
        ...
        (btc::DENOM.clone(), usdc::DENOM.clone()) => coins! {
            btc::DENOM.clone() => 1000000,
            usdc::DENOM.clone() => 1000000,
        },
    },
    vec![
    ...
    btree_map! {
        ...
        (btc::DENOM.clone(), usdc::DENOM.clone()) => coins! {
            btc::DENOM.clone() => 1000000 - 249999,
            usdc::DENOM.clone() => 1000000 + 333333,
        },
    };
...
#[test_case(
    ...
    Coin::new(usdc::DENOM.clone(), 500000),
    coins! {
        dango::DENOM.clone() => 1000000,
    },
    BTreeMap::new(),
    Coin::new(dango::DENOM.clone(), 1000000),
    btree_map! {
        (dango::DENOM.clone(), usdc::DENOM.clone()) => coins! {
            dango::DENOM.clone() => 2000000,
            usdc::DENOM.clone() => 500000,
...
#[test_case(
    ...
    Coin::new(usdc::DENOM.clone(), 333333),
    coins! {
        dango::DENOM.clone() => 499999,
    },
    BTreeMap::new(),
    Coin::new(dango::DENOM.clone(), 499999),
    btree_map! {
        (dango::DENOM.clone(), usdc::DENOM.clone()) => coins! {
...
#[test_case(
    ...
    Coin::new(usdc::DENOM.clone(), 250000),
    coins! {
        dango::DENOM.clone() => 333333,
    },
    BTreeMap::new(),
    Coin::new(dango::DENOM.clone(), 333333),
    btree_map! {
        (dango::DENOM.clone(), usdc::DENOM.clone()) => coins! {
...
#[test_case(
    ...
    Coin::new(usdc::DENOM.clone(), 1000000),
    coins! {
        dango::DENOM.clone() => 1000000,
    },
    BTreeMap::new(),
...
#[test_case(
    ...
    Coin::new(btc::DENOM.clone(), 250000),
    coins! {
        dango::DENOM.clone() => 1000000,
    },
    BTreeMap::new(),
    ...
    btree_map! {
        ...
        (btc::DENOM.clone(), usdc::DENOM.clone()) => coins! {
            btc::DENOM.clone() => 1000000 - 250000,
            usdc::DENOM.clone() => 1000000 + 333333,
        },
    };
...
#[test_case(
    ...
    Coin::new(usdc::DENOM.clone(), 499950),
    coins! {
        dango::DENOM.clone() => 1000000,
    },
    btree_map! {
