        ...
        GrugOption {
            ...
            fee_cfg: taxman::Config {
                ...
                referral: ReferralConfig {
                    ...
                    commission_rebound_default: CommissionRebound::new(
                        Udec128::checked_from_ratio(10, 100).unwrap(),
                    )
                    .unwrap(),
                    commission_rebound_by_volume: btree_map!(
                        Udec128::new(10_000_000) => CommissionRebound::new(Udec128::new_percent(20)).unwrap(),
                        Udec128::new(100_000_000) => CommissionRebound::new(Udec128::new_percent(30)).unwrap(),
                        Udec128::new(1_000_000_000) => CommissionRebound::new(Udec128::new_percent(40)).unwrap(),
                    ),
                },
            },
