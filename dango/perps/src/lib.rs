...
pub fn execute(ctx: MutableCtx, msg: ExecuteMsg) -> anyhow::Result<Response> {
    match msg {
        ExecuteMsg::Maintain(msg) => match msg {
            ...
            MaintainerMsg::ReplenishInsuranceFund { amount } => {
                maintain::replenish_insurance_fund(ctx, amount)
            },
        },
        ExecuteMsg::Trade(msg) => match msg {
            ...
            TraderMsg::CancelOrder(CancelOrderRequest::ByClientOrderId(client_order_id)) => {
                trade::cancel_by_client_order_id(ctx, client_order_id)
            },
