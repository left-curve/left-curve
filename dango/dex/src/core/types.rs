use {
    ...
    grug::{Addr, MathResult, Number, NumberConst, Udec128, Udec256, Uint64, Uint128},
};
...
pub trait OrderTrait {
    ...
    fn clear(&mut self) -> Udec256 {
        let remaining = *self.remaining();
        *self.remaining_mut() = Udec256::ZERO;
        remaining
    }
}
