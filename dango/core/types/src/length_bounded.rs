...
mod tests {
    ...
    invalid_case! {
        ...
        min   = 4,
        max   = 5,
        error = "length of dango_primitives::encoded_bytes::EncodedBytes<alloc::vec::Vec<u8>, dango_primitives::encoders::Base64Encoder> out of range: 3 < 4",
    ...
    invalid_case! {
        ...
        min   = 4,
        max   = 5,
        error = "length of dango_primitives::encoded_bytes::EncodedBytes<alloc::vec::Vec<u8>, dango_primitives::encoders::Base64Encoder> out of range: 6 > 5",
        name  = "binary_to_long",
    }
