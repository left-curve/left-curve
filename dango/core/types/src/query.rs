...
pub enum Query {
    ...
    PastUpgrades(QueryPastUpgradesRequest),
...
impl Query {
    ...
    pub fn past_upgrades(start_after: Option<u64>, limit: Option<u32>) -> Self {
        QueryPastUpgradesRequest { start_after, limit }.into()
    }
...
#[derive(Serialize, Deserialize, BorshSerialize, BorshDeserialize, Debug, Clone, PartialEq, Eq)]
pub struct QueryPastUpgradesRequest {
...
impl_into_query! {
    ...
    PastUpgrades => QueryPastUpgradesRequest => BTreeMap<u64, PastUpgrade>,
...
pub enum QueryResponse {
    ...
    PastUpgrades(BTreeMap<u64, PastUpgrade>),
    Balance(Coin),
    Balances(Coins),
    Supply(Coin),
    Supplies(Coins),
