...
///
/// In Dango's Wasm VM, this is used for calling a contract with dynamically-sized
...
///   it creates a `dango_ffi::Region` instance that describes this region,
///   and return the pointer (i.e. memory address) to this descriptor.
/// - The host dereferences the pointer into a `dango_vm_wasm::Region` instance,
///   and loads the input data into the region it describes.
///
/// ## Note
///
/// Do not confuse `dango_ffi::Region` and `dango_vm_wasm::Region`!
///
