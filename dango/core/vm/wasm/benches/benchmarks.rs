use {
    ...
    dango_app::{GasTracker, Instance, QuerierProviderImpl, StorageProvider, Vm},
    dango_crypto::sha2_256,
    dango_primitives::{
        Addr, BlockInfo, BorshSerExt, Context, GenericResult, Hash, JsonSerExt, MockStorage,
        Timestamp,
    },
    dango_tester::QueryMsg,
    dango_vm_wasm::WasmVm,
    std::time::Duration,
};
...
static BENCHMARKER_CODE: &[u8] = include_bytes!("../testdata/dango_tester.wasm");
