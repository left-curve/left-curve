use {
    dango_app::{AppError, GasTracker, Instance, QuerierProvider, StorageProvider, Vm},
    dango_backtrace::Backtraceable,
    dango_primitives::{Context, Hash256},
    dango_vm_rust::{RustInstance, RustVm},
    dango_vm_wasm::{WasmInstance, WasmVm},
...
pub enum VmError {
    ...
    Rust(dango_vm_rust::VmError),

    #[error("WasmVm error: {0}")]
    Wasm(dango_vm_wasm::VmError),
}
