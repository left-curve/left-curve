...
/// Data that the account expects for the transaction's [`credential`](grug_types::Tx::credential)
/// field.
...
/// Data that the account expects for the transaction's [`data`](grug_types::Tx::data)
/// field.
#[grug_types::derive(Serde)]
pub struct Metadata {
