use grug::{Denom, Timestamp, Udec128, Uint128, ZeroInclusiveOneExclusive};
...
pub struct PerpsMarketParams {
    ...
    pub position_open_fee: ZeroInclusiveOneExclusive,
    /// The fee for closing a position in the market.
    pub position_close_fee: ZeroInclusiveOneExclusive,
