...
mod tests {
    use {
        super::*,
        crate::oracle::{GUARDIANS_ADDRESSES, GUARDIAN_SETS_INDEX},
        grug::{Duration, Hash160, Hash256, JsonDeExt, MockApi, MockStorage, NonZero, Timestamp},
    };
    ...
    fn des_pyth_vaa() {
        ...
        str.deserialize_json::<PythVaa>().unwrap();
    }
