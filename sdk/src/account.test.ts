...
import { Message, createSignBytes, encodeHex } from ".";
...
test("creating sign bytes", () => {
  ...
  expect(encodeHex(signBytes)).toStrictEqual("baf97f186c39cbb4d4738ee98e8914e6738685cce45c59ca702d201f3375540a");
})
