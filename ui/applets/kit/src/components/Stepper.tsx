  ...
  return (
    <div
      className={twMerge(
        ...
        "before:content-[''] before:absolute before:z-10 before:bg-surface-primary-rice before:border before:border-red-bean-400 before:w-7 before:h-7 before:rounded-full before:bg-red-bean-400 before:transition-all",
        "",
        active === index
