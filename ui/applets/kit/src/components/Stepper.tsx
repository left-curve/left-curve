            ...
            <div className="relative">
              ...
              <p
                className={twMerge(
                  ...
                  { "text-primitives-red-light-600 top-[38px]": isActive },
                )}
              >
                {step as string}
              </p>
            ...
            {i < steps.length - 1 && (
              <span
                className={twMerge(
                  ...
                  i < activeStep ? "bg-primitives-red-light-500" : "bg-outline-secondary-gray",
                )}
              />
            )}
          </React.Fragment>
    ...
    <div
      className={twMerge(
        ...
        active === index
          ...
          : "border-outline-primary-gray before:scale-0 bg-outline-secondary-gray w-6 h-6 border-2",
      )}
    >
      <div
        className={twMerge(
