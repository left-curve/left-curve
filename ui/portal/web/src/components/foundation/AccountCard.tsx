...
const Preview: React.FC<AccountCardPreviewProps> = ({ account, onAccountSelect }) => {
  ...
  return (
    <div
      className={twMerge(
        "shadow-account-card w-full max-w-[22.5rem] md:max-w-[20.5rem] lg:min-w-[20.5rem] h-[9.8rem] relative overflow-hidden rounded-xl flex flex-col justify-between p-4 cursor-pointer",
        "mb-[-6.2rem]",
        "flex-shrink-0",
        bgColor,
      )}
