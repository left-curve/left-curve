...
export const OrderBookOverview: React.FC = () => {
  ...
  return (
    <ResizerContainer
      ...
      className="flex-1 lg:flex-none p-4 shadow-card-shadow bg-rice-25 flex flex-col gap-2 w-full xl:[width:clamp(279px,20vw,330px)] min-h-[27.25rem] lg:min-h-[37.9rem]"
    >
      <Tabs
        color="line-red"
