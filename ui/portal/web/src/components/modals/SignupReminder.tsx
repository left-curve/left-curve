  ...
  return (
    <div className="w-full flex flex-col items-center justify-start bg-surface-primary-rice rounded-xl border border-outline-secondary-gray max-w-2xl">
      <div className="flex flex-col relative gap-4 p-4">
        ...
        <p className="h4-bold text-ink-primary-900">Reminder</p>
        <div className="flex flex-col diatype-m-medium text-ink-tertiary-500 gap-4">
          ...
          <p>
            ...
            <span className="font-bold">
              Make sure to register with the Ethereum wallet you intend to use to claim the reward.
            </span>{" "}
            Users registered using email or social media accounts won't be able to claim the
            rewards.
          </p>

          <p>Data from the previous testnets are not carried over. Please register again.</p>
