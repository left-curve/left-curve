...
export const ProSwapEditTPSL = forwardRef(() => {
  ...
  return (
    <div className="flex flex-col bg-bg-primary-rice md:border border-secondary-gray pt-0 md:pt-6 rounded-xl relative p-4 md:p-6 gap-5 w-full md:max-w-[30rem]">
