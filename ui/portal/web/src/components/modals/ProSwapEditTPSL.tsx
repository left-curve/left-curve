...
export const ProSwapEditTPSL = forwardRef(() => {
    ...
    <div className="flex flex-col bg-white-100 md:border border-gray-100 pt-0 md:pt-6 rounded-xl relative p-4 md:p-6 gap-5 w-full md:max-w-[30rem]">
      ...
      <div className="flex flex-col  gap-1">
        ...
        <div className="w-full flex gap-2 items-center justify-between">
          ...
          <p className="diatype-sm-medium text-status-success">Market</p>
        </div>
        <div className="w-full flex gap-2 items-center justify-between">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1">
          <div className="flex gap-2">
            ...
            <Input placeholder="0" label="Loss" classNames={{ base: "max-w-[6rem]" }} />
          </div>
          <p className="text-gray-500 diatype-sm-regular text-right">Expected profit: 0.00 USDC</p>
        </div>
