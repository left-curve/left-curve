...
export const ProSwapEditedSL = forwardRef(() => {
  ...
  return (
    <div className="flex flex-col bg-surface-primary-rice md:border border-overlay-secondary-gray pt-0 md:pt-6 rounded-xl relative p-4 md:p-6 gap-5 w-full md:max-w-[30rem]">
      ...
      <div className="flex flex-col  gap-1">
        <div className="w-full flex gap-2 items-center justify-between">
          ...
          <p className="diatype-sm-medium text-ink-secondary-700">ETH</p>
        </div>
        <div className="w-full flex gap-2 items-center justify-between">
        ...
        <div className="w-full flex gap-2 items-center justify-between">
          ...
          <p className="diatype-sm-medium text-ink-secondary-700">82.145</p>
        </div>
        <div className="w-full flex gap-2 items-center justify-between">
        ...
        <div className="w-full flex gap-2 items-center justify-between">
          <p className="diatype-sm-regular text-ink-tertiary-500">Stop Loss</p>
          <div className="flex flex-col items-end">
            <p className="diatype-sm-medium text-ink-secondary-700">Price below 7000</p>
            <p className="diatype-sm-medium text-ink-secondary-700">Expected loss: -2.06 USDC</p>
          </div>
        </div>
      </div>
