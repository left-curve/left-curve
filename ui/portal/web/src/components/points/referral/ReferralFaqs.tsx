...
const faqs: FaqItem[] = [
  {
    ...
    answer:
      "A friend with a contract trading volume >= 100K will become your valid friend.",
  },
  {
...
export const ReferralFaqs: React.FC = () => {
  return (
    <div className="w-full flex flex-col gap-4">
      <h3 className="exposure-m-italic text-ink-primary-900">FAQs</h3>
      <div className="flex flex-col gap-3">
        {faqs.map((faq, index) => (
          <div key={faq.question} className="flex flex-col gap-1">
            ...
            <p className="text-ink-tertiary-500 diatype-m-regular pl-4">{faq.answer}</p>
          </div>
        ))}
      </div>
    </div>
