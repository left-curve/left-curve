...
export const SessionCountdown: React.FC = () => {
  ...
  return (
    <div className="flex gap-1 text-ink-secondary-700 px-4 py-3 md:shadow-account-card rounded-md md:min-w-[12.375rem] h-[46px] items-center justify-end md:justify-center">
      {[
