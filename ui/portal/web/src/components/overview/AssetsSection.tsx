...
export const AssetsSection: React.FC<Props> = ({ balances, showAllAssets }) => {
  ...
  return (
    <div className="flex-col bg-rice-25 [box-shadow:0px_-1px_2px_0px_#F1DBBA80,_0px_2px_4px_0px_#AB9E8A66] lg:flex rounded-xl p-4 gap-2 w-full h-full  min-h-[9.8rem]">
