import { Button, twMerge, useApp, useClickAway } from "@left-curve/applets-kit";
...
export const NotificationsMenu: React.FC<Props> = ({ buttonRef }) => {
  ...
  return (
    <div
      ref={menuRef}
      className={twMerge(
        "hidden lg:block transition-all absolute top-[75px] bg-surface-tertiary-rice shadow-account-card z-50 right-0 rounded-xl w-[27rem] duration-200",
