...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@left-curve/sdk/actions": path.resolve(root, "sdk/typescript/dango/src/actions/index.ts"),
      "@left-curve/sdk/hyperlane": path.resolve(
        root,
        "sdk/typescript/dango/src/hyperlane/index.ts",
      ),
