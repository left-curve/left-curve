    ...
    Int<U>: Number + NumberConst + Sign + IsZero,
{
    ...
    pub fn into_int(self) -> Int<U> {
        #[allow(
            clippy::unwrap_used,
            reason = "Self::PRECISION is necessarily non-zero"
        )]
    ...
    pub fn into_int_floor(self) -> Int<U> {
        ...
        match (rem.is_zero(), rem.is_negative()) {
            ...
            #[allow(
                clippy::unwrap_used,
                reason = "the biggest value supported by `Int<U>` is necessarily more than one unit bigger than that by `Dec<U, S>`"
            )]
    ...
    pub fn into_int_ceil(self) -> Int<U> {
        ...
        match (rem.is_zero(), rem.is_negative()) {
            ...
            #[allow(
                clippy::unwrap_used,
                reason = "the smallest value supported by `Int<U>` is necessarily more than one unit smallest than that by `Dec<U, S>`"
            )]
