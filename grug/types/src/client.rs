use {
    crate::{
        Addr, Binary, Block, CheckTxError, CheckTxOutcome, CheckTxSuccess, Code, Coins, Config,
        ContractInfo, Denom, Hash256, JsonDeExt, Query, QueryRequest, QueryResponse, ResultExt,
        StdError, Tx,
    },
...
impl<Q> QueryClientExt for Q
where
    Q: QueryClient + Send + Sync,
