    ...
    E: Display,
{
    ...
    let res = (|| {
        ...
        instantiate_fn(ctx, msg).map_err(|err| err.to_string())
    })();
    ...
    E: Display,
{
    ...
    let res = (|| {
        ...
        execute_fn(ctx, msg).map_err(|err| err.to_string())
    })();
    ...
    E: Display,
{
    ...
    let res = (|| {
        ...
        query_fn(immutable_ctx, msg).map_err(|err| err.to_string())
    })();
    let res_bytes = res.to_borsh_vec().unwrap();
    ...
    E: Display,
{
    ...
    let res = (|| {
        ...
        migrate_fn(ctx, msg).map_err(|err| err.to_string())
    })();
    ...
    E: Display,
{
    ...
    let res = (|| {
        ...
        reply_fn(ctx, msg, events).map_err(|err| err.to_string())
    })();
    ...
    E: Display,
{
    ...
    let res = (|| {
        ...
        receive_fn(ctx).map_err(|err| err.to_string())
    })();
    ...
    E: Display,
{
    ...
    let res = (|| {
        ...
        cron_execute_fn(ctx).map_err(|err| err.to_string())
    })();
    ...
    E: Display,
{
    ...
    let res = (|| {
        ...
        authenticate_fn(ctx, tx).map_err(|err| err.to_string())
    })();
    ...
    E: Display,
{
    ...
    let res = (|| {
        ...
        backrun_fn(ctx, tx).map_err(|err| err.to_string())
    })();
    ...
    E: Display,
{
    ...
    let res = (|| {
        ...
        transfer_fn(ctx, msg).map_err(|err| err.to_string())
    })();
    ...
    E: Display,
{
    ...
    let res = (|| {
        ...
        query_fn(ctx, msg).map_err(|err| err.to_string())
    })();
    ...
    E: Display,
{
    ...
    let res = (|| {
        ...
        withhold_fee_fn(auth_ctx, tx).map_err(|err| err.to_string())
    })();
    ...
    E: Display,
{
    ...
    let res = (|| {
        ...
        finalize_fee_fn(auth_ctx, tx, outcome).map_err(|err| err.to_string())
    })();
